...
import { IOrder, IOrderItem } from "@/types&const";
    ...
    const message = {
      ...
      <body style="font-family: Arial, sans-serif; background-color: #f4f4f9; color: #333;">
        <div style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 8px;">
          ...
          <h3 style="font-size: 18px; text-align: right;">Shipping Charge: <strong>${formatCurrency(90)}</strong></h3>
          `}
          ...
          <div style="margin-top: 20px; text-align: center;">
            <p style="font-size: 16px;">Thank you for shopping with us! If you have any questions about your order, feel free to contact us at <strong>alqami@gmail.com</strong>.</p>
