  ...
  const values = [
    {
      ...
      description:
        "Harnessing earth's untouched resources for authentic beauty,Ancient recipes modernized with scientific precision",
    },
    {
      icon: <Gem className="w-8 h-8 text-amber-600" />,
      title: "Rare Formulations",
      description:
        "Ancient recipes modernized with scientific precision,Harnessing earth's untouched resources for authentic beauty",
    },
    {
      icon: <HeartHandshake className="w-8 h-8 text-rose-600" />,
      title: "Ethical Legacy",
      description:
        "From our family to yours - generations of trust,Ancient recipes modernized with scientific precision",
    },
    {
      icon: <Sprout className="w-8 h-8 text-lime-600" />,
      title: "Sustainable Future",
      description:
        "Committed to eco-friendly practices for a greener tomorrow,From our family to yours - generations of trust",
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className=" space-y-8 z-10 flex flex-col justify-center text-center">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl text-stone-800 tracking-tighter">
              <TextAnimate animation="blurInUp" by="word" once as={"span"} delay={0.1}>
                The
              </TextAnimate>{" "}
              <TextAnimate
                animation="blurInUp"
            ...
            <p className="text-stone-600 text-lg max-w-lg mx-auto">
              Where centuries-old wisdom meets modern skincare science. Our
              formulations are born from nature, perfected by tradition, and
