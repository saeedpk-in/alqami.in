...
const orderSchema = new Schema<Order>({
  ...
  dtdcTrackingNo: { type: String, default: null },
  dtdcReferenceNumber: { type: String, default: null }
});

delete models.Order; // Delete the model if it already exists to avoid OverwriteModelError
const Orders =
