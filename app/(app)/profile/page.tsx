...
const page = () => {
        ...
        try {
          ...
          if (sessionId) {
            ...
            if (response.success && response.user) {
              ...
              form2.setValue("postalCode", response.user.address.postalCode);
  ...
  return (
    <div className="flex flex-col h-full min-h-screen items-center justify-center">
      <Button className="ml-auto mr-10 rounded-full" onClick={() => signOut()}><LogOut/> LogOut</Button>
      <div className=" gap-10 flex flex-col ">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-tight max-w-5xl text-gray-900 mb-3 sm:mb-4">
          Your Profile
        </h1>
        <div className="flex ">
